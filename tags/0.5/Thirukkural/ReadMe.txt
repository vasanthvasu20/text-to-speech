========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Vak
========================================================================


AppWizard has created this Vak application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Vak application.
...
res\Vak.ico
    ...
    icon is included by the main resource file Vak.rc.
...
VakDlg.h, VakDlg.cpp - the dialog
    These files contain your CVakDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Vak.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CVakDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Vak.pch and a precompiled types file named StdAfx.obj.
